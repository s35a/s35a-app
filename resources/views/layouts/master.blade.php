...
<head>
  ...
  <title>STUDIO 35A | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="./img/s35a_logo.png"
           alt="Studio35a Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">STUDIO 35A</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">BENEFIT</li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-share text-info"></i>
              <p class="text">Refer a friend</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-people-carry text-success"></i>
              <p>Affliate</p>
            </a>
          </li>
          <li class="nav-item has-treeview">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http://studio35.org">STUDIO35A</a>.</strong> All rights
    reserved.
  </footer>
